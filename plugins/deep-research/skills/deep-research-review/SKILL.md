...
- **What scored well.** From `log.md` (the per-round `scores:` lines, grouped by direction): which directions and findings files scored highest, and why (which soft gates they passed).
